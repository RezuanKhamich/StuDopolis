...
import {Model_Obj} from "./82a";
import {Model_Obj2} from "./Room";
...
function Model() {
  ...
  const [items, setItems] = useState([
    {id: '1', name: 'Санузел', price: 2000, isBought: false},
    {id: '1', name: 'Санузел', price: 2000, isBought: false},
    {id: '1', name: 'Санузел', price: 2000, isBought: false},
    {id: '1', name: 'Санузел', price: 2000, isBought: false},
    {id: '1', name: 'Санузел', price: 2000, isBought: false},
  ...
  const buyHandler = () => {
    ...
    tempArray[selectedItemIndex].isBought = true;
    setItems([...tempArray])
  }
    ...
    <div className="App" style={{ display: 'flex'}}>
      <Canvas style={{ width: '100%', height: '1000px' }}>
        {/*<Suspense fallback={null}>*/}
          {/*<Model_object />*/}
          <Scene items={items} setSelectedItemIndex={setSelectedItemIndex}/>
          <OrbitControls />
      ...
      </Canvas>
      {
        selectedItemIndex || selectedItemIndex === 0 ? (
          <div style={buyStyle}>
            ...
            <h1>{items[selectedItemIndex]?.name}</h1>
            <h3>Цена: <h1>{items[selectedItemIndex]?.price}</h1></h3>
