...
export const coursesData = [
  { name: 'Разработка сайтов и веб-приложений',
    ...
    description: `Разработка современных веб-приложений на базе Javascript, React.js.`,
    moduleDescription: [
      'Изучение основ HTML5 для эффективного сайтостроения.',
      'Красочный и интерактивный дизайн вместе с CSS3',
      'Учимся писать оптимизированный код на Javascript',
      'Повышаем интерактивность сайта с JavaScript',
      'Разработка сайта через компоненты вместе с React',
    ],
    passingTime: '4,5',
    disabled: false,
  },
